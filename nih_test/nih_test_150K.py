...
# Original DTM (without RCDC code initialization)
dtm_path = '/Users/jihyun/Documents/jihyun/research/topicmodel/dtm/dtm-master/bin/dtm-darwin64'

data_prefix = '/Users/jihyun/Documents/jihyun/research/topicmodel/codes/dtm/gensim_python/nih_test/data_150K_noinit/'
...
### To include only some part of the corpus
...
model = wrappers.DtmModel(dtm_path, corpus, timeslices, num_topics=80, id2word=dictionary, prefix=data_prefix, initialize_lda=True)
print(datetime.datetime.now())
